...
const handlerSubmit = async () => {
    try {
        ...
        if(bookStore.statusMsg === 'success'){
            alert('El libro se creó con éxito');
                ...
                <div class="grid gap-4 sm:grid-cols-4 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="isbn" id="isbn"
                            placeholder="Agregar el código ISBN"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="author" id="author"
                            placeholder="Agregar el nombre del autor"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="url" id="url"
                            placeholder="Agregar la url del libro"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="category" id="category"
                            placeholder="Agregar la categoría del libro"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
