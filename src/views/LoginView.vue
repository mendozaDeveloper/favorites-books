...
<template>
  ...
  <section class="bg-gray-50 dark:bg-gray-900">
    <div
      class="flex flex-col items-center px-6 mx-auto md:h-screen lg:py-0"
    >
      <div
        class="w-full mt-10 bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700"
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Login</h1>
          <form class="space-y-4 md:space-y-6" @submit.prevent="handlerSubmit">
            <div>
              <label
                for="email"
